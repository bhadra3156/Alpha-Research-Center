...
print(f"NVDA C1: {'PASS' if c1p else 'FAIL'} score={c1['score']} quality={c1['quality']}")
print(f"NVDA C2: {'PASS' if c2p else 'FAIL'} stage={c2['stage']}")
print(f"NVDA qualifies: {c1p and c2p}")